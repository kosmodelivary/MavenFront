				...
				<form id="memberWithdrawForm" name="memberWithdrawForm">
					<div class="memberOut">
						<div class="first">
							<h2>개인정보 안내</h2>
							<p>
								그 동안 버거킹 딜리버리를 이용해 주셔서 감사합니다. <br />사용하시면서 불편하셨던 점이나 불만사항을
								알려주시면 적극 반영하여 향후 개선하도록 하겠습니다. <br />아울러 회원 탈퇴 시 아래사항을 숙지하시기
								바랍니다.
							</p>
						...
						<div>
							...
							<div class="inp_wid wid4">
								<input type="password" name="password" id="password"
									...
									title="비밀번호 입력" maxlength="20" /> <a
									href="javascript:void(0);" class="button w120 ml6"
									id="memberWithdraw">회원탈퇴</a>
							</div>
						</div>
					</div>
				</form>
