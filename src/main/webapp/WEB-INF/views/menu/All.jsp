...
<aside id="lnb">
	...
	<nav>
		<ul>
			...
			<li><a href="SpecialOffer.html">스페셜오퍼</a>
				<ul>
					<li><a href="Limited.html">기간한정</a></li>
				</ul></li>
			<li><a href="SetMenu.html">세트메뉴</a>
				<ul>
					<li><a href="WhopperSet.html">와퍼세트</a></li>
					<li><a href="GarlicSet.html">갈릭세트</a></li>
					<li><a href="Beef%26ChickenSet.html">비프&amp;치킨 세트</a></li>
				</ul></li>
			<li><a href="Burger.html">버거</a>
				<ul>
					<li><a href="Whopper.html">와퍼</a></li>
					<li><a href="Garlic.html">갈릭</a></li>
					<li><a href="Beef%26Chicken.html">비프&amp;치킨</a></li>
				</ul></li>
			<li><a href="Side.html">사이드</a>
				<ul>
					<li><a href="Snack.html">스낵</a></li>
				</ul></li>
			<li><a href="Drink.html">드링크</a>
				<ul>
		...
		<ul class="menu_list">
			...
			<li>
				...
				<div class="list_cont">
					...
					<a class="btn_cart"
						href="javascript:PopupFunction.addProduct(&#39;7190338&#39;,1)"><span>담기</span></a>
					<a class="btn_view"
						href="javascript:PageFunction.openDetailPopup(&#39;7190338&#39;)"><span>상세보기</span></a>
				</div>
			</li>
			<!-- c:forEach로 구간반복 끝 -->
			<li><a
				...
				<div class="list_cont">
					<a class="btn_cart"
						href="javascript:PopupFunction.addProduct(&#39;7190339&#39;,1)"><span>담기</span></a>
					<a class="btn_view"
						href="javascript:PageFunction.openDetailPopup(&#39;7190339&#39;)"><span>상세보기</span></a>
				</div></li>
			<li><a
				href="javascript:PageFunction.openDetailPopup(&#39;7111350&#39;)">
					<figure>
						<img
				...
				<div class="list_cont">
					<a class="btn_cart"
						href="javascript:PopupFunction.addProduct(&#39;7111350&#39;,1)"><span>담기</span></a>
					<a class="btn_view"
						href="javascript:PageFunction.openDetailPopup(&#39;7111350&#39;)"><span>상세보기</span></a>
				</div></li>
			<li><a
				href="javascript:PageFunction.openDetailPopup(&#39;7111351&#39;)">
					<figure>
						<img
							src="../files/product/%eb%b6%89%ec%9d%80%eb%8c%80%ea%b2%8c%ed%86%b5%ec%83%88%ec%9a%b0%eb%b2%84%ea%b1%b0%ec%84%b8%ed%8a%b8_460x380.png"
							alt="붉은대게통새우버거세트" />
						<figcaption>
							<span class="tit">붉은대게통새우버거세트</span> <strong>8,200원</strong>
						</figcaption>
					</figure> <i></i>
			</a>
				<div class="list_cont">
					<a class="btn_cart"
						href="javascript:PopupFunction.addProduct(&#39;7111351&#39;,1)"><span>담기</span></a>
					<a class="btn_view"
						href="javascript:PageFunction.openDetailPopup(&#39;7111351&#39;)"><span>상세보기</span></a>
				</div></li>
		</ul>
