...
<section id="contents">
	...
	<div class="order_tit">
		<h2>정보입력</h2>
		<p>
			<img src="<c:url value='/resources/images/member/step2.gif'/>" alt="01약관동의, 02정보입력(현재위치), 03가입완료" />
		</p>
	</div>
		...
		<div class="form_list noline">
			...
			<ul>
				<li>
					...
					</div> <label class="error" for="emailValid" style="display: none; color: red; font-weight: bold"></label>
				</li>
				<li>
					<div class="inp_wid">
						<i>*</i>
					...
					</div> <label class="error" for="pass" style="display: none; color: red; font-weight: bold"></label>
				</li>
				<li>
					<div class="inp_wid">
						<i>*</i> 
						<input type="password" name="pass2" id="pass2" autocomplete="off" class="input" placeholder="비밀번호 재입력" title="비밀번호 재입력" maxlength="20"/>
					</div> <label class="error" for="pass2" style="display: none; color: red; font-weight: bold"></label>
				</li>
			</ul>
		</div>
		<div class="form_list">
			...
			<ul>
				<li>
					...
					</div> <label class="error" for="custName" style="display: none; color: red; font-weight: bold"></label>
				</li>
			</ul>
		</div>
		<div class="form_list">
			...
			<ul>
				<li>
					...
					</div> <label class="error" for="phone" style="display: none; color: red; font-weight: bold"></label>
				</li>
			</ul>
		</div>
		<div class="form_list">
			...
			<ul>
				...
				<li>
					<div class="inp_wid">
						<i>*</i> <input type="text" name="member_answer" id="answer" class="input" placeholder="비번 찾기 정답 입력" title="비번 찾기 정답 입력" maxlength="20"/>
					</div> <label class="error" for="answer"
					style="display: none; color: red; font-weight: bold"></label>
				</li>
			</ul>
		</div>
		<div class="form_list">
			...
			<p>
				<label class="checkbox"> <input type="checkbox" checked="checked" id="eventSmsCheck" data-target="eventSms" name="member_agreesms" />
				 <span class="lbl">이벤트/주문정보의 SMS 수신을 동의합니다.</span>
				</label>
			</p>
			<p class="mt10">
				<label class="checkbox"> <input type="checkbox" checked="checked" id="eventEmailCheck" data-target="eventEmail" name="member_agreeemail" />
				 <span class="lbl">이벤트/주문정보의 이메일 수신을 동의합니다. 정확한 정보를 입력해주세요.</span>
				</label>
			</p>
		</div>
		<p class="button_area btn2 mt30">
			<input type="submit" class="button h40 w200" value="확인"> <a href="<c:url value='/member/joinAgree.whpr'/>" class="button h40 w200 btn_gray">취소</a>
		</p>
	</form>
</section>
<!-- //contents -->
