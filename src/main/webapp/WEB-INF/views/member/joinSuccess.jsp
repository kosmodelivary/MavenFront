...
<!DOCTYPE html>
		...
		<section id="contents">
			...
			<div class="order_tit">
				<h2>정보입력</h2>
				<p><img src="../resources/images/member/step3.gif" alt="01약관동의, 02정보입력, 03가입완료(현재위치)" /></p>
			</div>
			<div class="form_list noline">
				<h3 class="cont_tit tit3">회원가입정보</h3>
				<ul class="comment_list">
					<li>고객님의 회원아이디는 <strong class="t_blue">${dto.member_email }</strong> 입니다.</li>
					<li>계정정보 분실 시 메뉴 <strong class="bold">내 아이디/비밀번호 찾기</strong>로 정보를 찾을 수 있습니다.</li>
				</ul>					
			</div>
